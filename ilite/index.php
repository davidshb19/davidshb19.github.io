...
<head>
	...
	<link rel="stylesheet" href="http://brick.a.ssl.fastly.net/Roboto:400"/>
    <!--[if lt IE 9]>
...
<div class="home__wrap" >
	...
	<div id="home__banner" class="home__banner">
		...
		<div class="home__banner__text-container">
			<h1>We are ilite cyber.</h1>
			<h2>Cyberpatriot Team //team number\\</h2>
			<h3>//get someone to replace\\ We are a team founded on the principles of leadership, teamwork, and academic rigor. Through competitions, outreach, and mentorship we passionately advocate for science and technology in our schools, communities, and throughout the world.</h3>
		</div>
<!--
    <div class="less5 centf bigtfont gray">Here at ILITE First Team 1885, we believe that every student is a leader. Through our different subteams of business, graphics, electronics, programming, and build, we work very hard to give every team member the opportunity to learn and lead. We have created an environment in which FIRST Robotics is so loved that our alumni volunteer across the nation even after graduating. </div><br>

	<div class="less5 centf bigtfont gray">Our leadership reaches beyond of FIRST Team 1885. We have created an identity for ourselves in our community, county, state, and nation. ILITE reaches out to our community through town festivals, charitable involvement, elementary school tutoring, and hosting our annual Haymaker STEM Expo. On a broader scale, ILITE members have lobbied politicians through their School Board and meetings at the Capitol to encourage the advancement of STEM in education. </div><br>
...
<a href="/about/missionandvision.php" class="button thhthree">LEARN MORE ABOUT OUR MISSION AND VISION!</a> </div>
</div><!-- end section -->

<div id="wrap5">

	<div class="featured_section142 A">
		<div class="container">

			<p class="home__section-header">events</p>
			<p class="home__section-sub-header">Come support Team //team number\\ and our work in the community.</p>
		  ...
		  <div class="addes">
		      ...
		      <strong><a href="https://www.google.com/">//summer camps\\</a></strong>
...
<div class="home__img e2"></div>
 ...
 <div class="addes">
		      <em><a href="//google maps location\\"><i class="fa fa-map-marker"></i> Google Map</a></em>
		      <strong><a href="community/hosted.php#ftc">//event name\\</a></strong>
					<strong>//date\\</strong>
					//location\\
				</div>
		  ...
		  <div class="one_third last animate" data-anim-type="fadeInUp" data-anim-delay="300">
		    ...
		    <div class="addes">
		      <em><a href="//google maps location\\"><i class="fa fa-map-marker"></i> Google Map</a></em>
		 	      <strong><a href="community/hosted.php#frc">//event name\\</a></strong>
			<strong>//date\\</strong>
					//location\\
				</div>
	...
	</div> <!-- end featured section 142 -->

	<div class="B home__news-container">
		<div class="container">

			<p class="home__section-header white">news</p>
			<p class="home__section-sub-header white">
				Stay up to date with the competitions, exhibitions, and educational outreach
				<span class="desktop-break">that ILITE frequently hosts and participates in.</span>
			</p>
			...
			<div class="flexbox-columns">
				...
				<div class="one_third animate" data-anim-type="fadeInUp" data-anim-delay="200">
					...
					<div class="addes">
						<center><strong><a href="http://www.signupgenius.com/go/30e084faea929a0fc1-ilite3">ILITE End of Year celebration</a></strong></center>
						<span class="desktop-break">ILITE Robotics and ILITE Cyber will be celebrating their successful year in this end of the year celebration. Sign up to bring food or sporting equipment to be used in the many fields/courts available at Long Park.</div>
				...
				<div class="one_third animate" data-anim-type="fadeInUp" data-anim-delay="250">
					<a class="home__img-holder" href="#">
						...
						<div class="addes">
						<strong><a href="http://google.com/">//news article\\</a></strong>
						<span class="desktop-break">//bref\\With 33 registered teams, the 2016 ILITE Robotics Off-Season Challenge was the largest ever held. The winning alliance was composed of FRC Teams 384, Sparky Robotics, 5338, RoboLoCos, and 2363, Triple Helix. Congratulations teams!</div>
...
<div class="addes">
						<strong><a href="http://google.com/">//news article\\</a></strong>
						<span class="desktop-break">//bref\\ILITE has been chosen to be kindness ambassadors for our school and community. Recent developments include enacting kindness rules at our high school, starting a kindness week at out school, and spreading kindess at the PWCS Walk for Autism.</div>
	...
	<div class="home__sponsors">
		...
		<div class="home__sponsors__container">
			...
			<div class="home__sponsors__logo-wrap">
				...
				<a href="https://www.army.mil/" class="home__sponsors__logo-link" target="_blank">
					<div style="background-image: url( images/sponsors/6.jpg )" class="home__sponsors__logo"></div>
				</a>
...
<a href="http://khouriortho.com/" class="home__sponsors__logo-link" target="_blank">
					<div style="background-image: url( images/sponsors/20.jpg )" class="home__sponsors__logo"></div>
				</a>
				
				<a href="www.townofhaymarket.org/" class="home__sponsors__logo-link" target="_blank">
					<div style="background-image: url( images/sponsors/21.jpg )" class="home__sponsors__logo"></div>
				</a>
				
				<a href="https://www.tropicalsmoothiecafe.com/" class="home__sponsors__logo-link" target="_blank">
					<div style="background-image: url( images/sponsors/22.png )" class="home__sponsors__logo"></div>
				</a>
				<a href="http://www.cathyshometeam.com/" class="home__sponsors__logo-link" target="_blank">
					<div style="background-image: url( images/sponsors/23.png )" class="home__sponsors__logo"></div>
				</a>
...
<div class="footer">
  <div class="footerInfo">
    ...
    <div class="col" >
      ...
      <p class="footer__text">ILITE Cyber</p>
...
<div class="footer__copyright">
  <p>&copy; <span id="copyright-year"></span> ILITE Cyber. All rights reserved.</p>
</div>
...
<nav id='side-menu' class='menu width-0'>
    ...
    <div id="side-menu__first" class="nav__link">
			Cyberpatriot <div class="caret"></div>
			<div class="nav__link__wrapper" id="side-menu__first__wrapper">
				<a href='/first/whatisfirst.php' class="nav__link__target">About Cyberpatriot</a>
...
<script type="text/javascript" src="js/cubeportfolio/main41.js"></script>
