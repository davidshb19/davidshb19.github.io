  ...
  <div class="nav-container">
    ...
    <div id="nav__first" class="nav__link">
			...
			<div class="nav__link__wrapper" id="nav__first__wrapper">
				<a href='cyberpatriot/whatiscyberpatriot.php' class="nav__link__target">About Cyberpatriot</a>
				<a href='http://www.northropgrumman.com/CorporateResponsibility/Pages/CyberPatriot.aspx' class="nav__link__target">Scholarships</a>
				<a href='cyberpatriot/cyberpatriotcampaign.php' class="nav__link__target">Cyberpatriot Outreach</a>
        <a href='cyberpatriot/season.php' class="nav__link__target">Cyberpatriot 2017-2018 Season</a>
			</div>
		</div>
